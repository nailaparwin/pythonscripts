...
for i in range(1, count):
    dt2[i] = 100 * abs(dt1[1] - dt2[i]) / dt1[1]
dt2.to_excel('abspercentVal.xlsx', engine='xlsxwriter') 

################plot###################

os.mkdir("abspercentplot")
dr = os.getcwd()
dr = dr + "/abspercentplot"
os.chdir(dr)
...
for i in range(1, count):
    ...
    plt.xlabel("x")
    plt.ylabel("100 * abs(y- y" + str(i) + ") / y");
